...
# Data Overview Page
    ...
    uploaded_file = st.file_uploader("Upload your `creditcard.csv` dataset here", type=["csv"])
    ...
    if uploaded_file is not None:
        ...
        st.info("Awaiting dataset upload. Please upload the `creditcard.csv` file to proceed.")
...
# Feature Importance Page
    ...
    **Models Analyzed:**
    ...
    # File uploader for dataset
    st.subheader("📥 Upload Dataset for Feature Importance")
    uploaded_file = st.file_uploader("Upload your `creditcard.csv` dataset here", type=["csv"])
...
# Model Evaluation Page
    ...
    **Comprehensive Model Assessment:**
    ...
    # File uploader for dataset
    st.subheader("📥 Upload Dataset for Model Evaluation")
    uploaded_file = st.file_uploader("Upload your `creditcard.csv` dataset here", type=["csv"])
...
# Simulator Page
    ...
    **Simulate and Predict Fraudulent Transactions:**
    ...
    # File uploader for dataset
    st.subheader("📥 Upload Dataset for Simulator")
    uploaded_file = st.file_uploader("Upload your `creditcard.csv` dataset here", type=["csv"])
