        ...
        with st.spinner("Generating PDF report..."):
            try:
                ...
                if not all(key in eval_data for key in required_keys):
                    ...
                    exec_summary = (
                        "This report provides an analysis of credit card transactions to identify and detect fraudulent activities. "
                        "It includes data overview and model evaluation results."
                    )
